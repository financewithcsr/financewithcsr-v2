...
function RelatedCalculators() {
  ...
  const calculators = [
    ...
    },
    {
      ...
      description: "Calculate EMI and total interest on your personal loan.",
      path: "/calculators/personal-loan",
      icon: "💳",
    },
    {
      title: "PPF Calculator",
      description: "Estimate your PPF maturity amount and interest.",
      path: "/calculators/ppf",
      icon: "🪙",
    },
    {
      title: "RD Calculator",
      description: "Calculate your Recurring Deposit maturity amount.",
      path: "/calculators/rd",
      icon: "💵",
    },
  ];
