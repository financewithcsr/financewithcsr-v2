...
function EightyCRelatedCalculators() {
  ...
  const calculators = [
    {
      ...
      description:
        "Calculate your PPF maturity value and long-term savings growth.",
      icon: "🛡️",
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Explore other calculators that can help
          you plan your investments and taxes.
        </p>
      </div>
...
export default EightyCRelatedCalculators;